  ...
  return (
    <section className="relative text-center py-32 min-h-[600px] flex items-center justify-center">
      ...
      <div className="relative container mx-auto px-6 z-10">
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto drop-shadow-lg leading-relaxed text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-400 to-orange-400">
