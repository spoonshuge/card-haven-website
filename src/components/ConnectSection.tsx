  ...
  return (
    <div className="space-y-8">
      <div className="text-center bg-white/95 backdrop-blur-sm p-8 rounded-2xl border border-green-200/50 shadow-xl">
        <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Connect With spoonLabs</h1>
      ...
      <div className="max-w-2xl mx-auto">
        <Card className="p-8 border-green-200/50 bg-white/95 backdrop-blur-sm shadow-xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600">daniel@spoonlabs.cards</p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600">@spoonlabss</p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600">@spoonshuge</p>
              </div>
            </a>
          ...
          <div className="mt-8 p-6 bg-green-50/90 rounded-lg border border-green-200/50">
            <h3 className="font-semibold text-green-900 mb-2">Show Times</h3>
            <p className="text-green-800">Tuesday: 10 - ?pm EST</p>
            <p className="text-green-800">Friday: 10 - ?pm EST</p>
            <p className="text-green-800">Sunday: Golf</p>
          </div>
        </Card>
      </div>
    </div>
