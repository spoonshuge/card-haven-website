...
const AboutSection = () => {
  ...
  return <section className="py-12 bg-white/80 backdrop-blur-sm rounded-xl border border-green-200/50 shadow-lg relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-base text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">Look it seems to me that no one really has a clue and we are all just winging it. Come see how I wing. Child of the JunkWax era and loved it. I still think about the Greg Maddux Upper Deck Spx, it came out of a box Dad bought for Christmas. Late 2024 I caugh the bug, bought way to much wax and set more money on fire with breaks. I have been trying to figure out the &quot;right&quot; way to participate in collecting ever since. I have bought a ton more, or course. On the other hand, I have sold across several platforms, a trade night, and set up at a show.</p>
